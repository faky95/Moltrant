...
// Returns the private 'App\Repository\EtudeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EtudeRepository.php';

return $this->privates['App\Repository\EtudeRepository'] = new \App\Repository\EtudeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
