...
{% macro render_bus_messages(messages, showBus = false) %}
    ...
    {% endfor %}
{% endmacro %}
", "WebProfilerBundle:Collector:messenger.html.twig", "/var/www/project/Moltrant-master/vendor/symfony/web-profiler-bundle/Resources/views/Collector/messenger.html.twig");
    }
}
