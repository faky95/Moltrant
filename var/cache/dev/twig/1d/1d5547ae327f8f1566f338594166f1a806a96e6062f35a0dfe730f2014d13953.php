...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "SecurityBundle:Collector:security.html.twig", "/var/www/project/Moltrant-master/vendor/symfony/security-bundle/Resources/views/Collector/security.html.twig");
    }
}
