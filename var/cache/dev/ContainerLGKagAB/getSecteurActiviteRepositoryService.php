...
// Returns the private 'App\Repository\SecteurActiviteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SecteurActiviteRepository.php';

return $this->privates['App\Repository\SecteurActiviteRepository'] = new \App\Repository\SecteurActiviteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
