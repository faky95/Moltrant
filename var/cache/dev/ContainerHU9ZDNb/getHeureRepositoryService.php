...
// Returns the private 'App\Repository\HeureRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/HeureRepository.php';

return $this->privates['App\Repository\HeureRepository'] = new \App\Repository\HeureRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
