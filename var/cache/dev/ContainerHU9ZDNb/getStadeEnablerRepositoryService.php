...
// Returns the private 'App\Repository\StadeEnablerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/StadeEnablerRepository.php';

return $this->privates['App\Repository\StadeEnablerRepository'] = new \App\Repository\StadeEnablerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
