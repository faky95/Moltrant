...
class srcApp_KernelDevDebugContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function __construct(RequestContext $context)
    {
        ...
        $this->dynamicRoutes = [
            ...
            196 => [[['_route' => 'detail', '_controller' => 'App\\Controller\\ServiceController::detail'], ['id'], null, null, false, true, null]],
            222 => [[['_route' => 'remove', '_controller' => 'App\\Controller\\ServiceController::deleteService'], ['id'], null, null, false, true, null]],
            260 => [[['_route' => 'fos_user_registration_confirm', '_controller' => 'fos_user.registration.controller:confirmAction'], ['token'], ['GET' => 0], null, false, true, null]],
            290 => [[['_route' => 'fos_user_resetting_reset', '_controller' => 'fos_user.resetting.controller:resetAction'], ['token'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        ];
    }
}
