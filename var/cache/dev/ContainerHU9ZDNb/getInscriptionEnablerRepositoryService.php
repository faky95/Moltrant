...
// Returns the private 'App\Repository\InscriptionEnablerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/InscriptionEnablerRepository.php';

return $this->privates['App\Repository\InscriptionEnablerRepository'] = new \App\Repository\InscriptionEnablerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
