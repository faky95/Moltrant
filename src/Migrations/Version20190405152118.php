 ...
 */
final class Version20190405152118 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE photo (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, avatar LONGBLOB NOT NULL, INDEX utilisateur_id (utilisateur_id), UNIQUE INDEX UNIQ_14B78418FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
