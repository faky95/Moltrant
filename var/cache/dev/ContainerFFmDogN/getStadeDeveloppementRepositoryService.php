...
// Returns the private 'App\Repository\StadeDeveloppementRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/StadeDeveloppementRepository.php';

return $this->privates['App\Repository\StadeDeveloppementRepository'] = new \App\Repository\StadeDeveloppementRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
