...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "SecurityBundle:Collector:security.html.twig", "/home/faky/Bureau/IntranetEnablis/vendor/symfony/security-bundle/Resources/views/Collector/security.html.twig");
    }
}
