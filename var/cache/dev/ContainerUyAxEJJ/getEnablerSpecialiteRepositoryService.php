...
// Returns the private 'App\Repository\EnablerSpecialiteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EnablerSpecialiteRepository.php';

return $this->privates['App\Repository\EnablerSpecialiteRepository'] = new \App\Repository\EnablerSpecialiteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
