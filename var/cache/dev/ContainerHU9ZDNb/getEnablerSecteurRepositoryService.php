...
// Returns the private 'App\Repository\EnablerSecteurRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EnablerSecteurRepository.php';

return $this->privates['App\Repository\EnablerSecteurRepository'] = new \App\Repository\EnablerSecteurRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
